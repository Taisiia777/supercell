...
//         title: "Товары",
//         nameColumns: [
//             { nameColumn: "Наименование", nameResponse: "title" }, 
//             { nameColumn: "Описание", nameResponse: "description" }, 
//             { nameColumn: "Стоимость", nameResponse: "price" }
//         ],
//         countRow: 4,
...
//         title: "Заказы",
//         nameColumns: [
//             { nameColumn: "№ заказа", nameResponse: "number" }, 
//             { nameColumn: "Дата и время", nameResponse: "date_placed" }, 
//             { nameColumn: "Статус", nameResponse: "status" }, 
//             { nameColumn: "ID Клиента", nameResponse: "user" }, 
//             { nameColumn: "Сумма", nameResponse: "total" }
//         ],
//         countRow: 4,
//         filterParams: [
//             { title: "Статус", filter: "statusName" }, 
//             { title: "Дата заказа", filter: "date", type: "date" }
//         ]
//     },
// };
...
//     onOrderView?: (orderId: number) => void // Callback when viewing an order
// }
...
//     // НЕ очищаем пометку автоматически
//     // Просто передаем ID для навигации
...
//                                     <ClampLines 
//                                         text={item.description ? item.description.replace(/<\/?[a-zA-Z]+>/gi, '') : "(пусто)"} 
//                                         lines={3} 
//                                         ellipsis="" 
//                                         id={"desc-" + item.id} 
//                                         buttons={false} 
...
//                                 >
//                                     {statusOrder[item.status.toUpperCase()]}
//                                 </div>
//                                 <div className={"col " + style.col}>
