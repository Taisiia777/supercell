...
//     const filteredOrders = useMemo(() => {
//         if (!data || !searchParams.query) return data;
    
//         return data.filter((order: IOrder) => {
//             const query = searchParams.query.toLowerCase();
...
//             // Для поиска по Telegram ID
//             if (searchParams.type === 'telegram_id') {
//                 // Получаем ID пользователя и убираем префикс "TG:"
//                 const userIdStr = order.user.username.toString();
//                 const cleanUserId = userIdStr.replace('TG:', '');
                
//                 // Сравниваем очищенный ID с поисковым запросом
//                 return cleanUserId.includes(query);
//             }
...
//     return (
//         <>
//             {/* <OrderSearch onSearch={setSearchParams} /> */}
//             {filteredOrders && (
//                 <TablePage 
//                     setParamsFilter={setParamsFilter} 
//                     style={style} 
