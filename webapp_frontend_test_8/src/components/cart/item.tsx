...
export default function ProductItem(props: {item: IProduct, count?: number, isLoading: boolean, counter: boolean, account_id?: string, link?: string, code?: string, handleEnd?: (data : {productId: number, type: "account_id" | "link" | "code", value: string}[]) => void}) {
    ...
    return (
        <div className={styles.item}>
            <Link href={`/product/${props.item.id}`} className={styles.content}>
                <div className={styles.container}>
                    <div className={styles.img}>
                        ...
                        <div className={styles.type}>
                            {props.item.login_type === "EMAIL_CODE" || props.item.login_type === "URL_EMAIL" ? (
                    ...
                    <div className={styles.product}>
                        ...
                        <div className={styles.category}>
                            ...
                            <span>{props.item.categories}</span>
                        </div>
                        <div className={styles.actions}>

                            <p className={styles.price}>{props.item.price.incl_tax} ₽</p>
                                    ...
                                    <>
                                        {
                                            props.isLoading ? (
                                                ...
                                                <ActionButtons id={props.item.id} count={props.count} game={props.item.game} style={{
                                                    background: "#242C3B",
                                                    padding: "0 4px",
