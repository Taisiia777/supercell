...
function ButtonAdd(props: IProductAdd) {
    ...
    const handleClick = (e: any) => {
        ...
        // Вызов addItem без показа успешного уведомления
        // Ошибки будут обрабатываться внутри addItem
        addItem(props.id, props.game, loginType);
        ...
        setTimeout(() => {
            window.scrollTo({
                top: scrollPosition,
                behavior: 'instant' // Моментальная прокрутка без анимации
            });
        }, 0);
    }
