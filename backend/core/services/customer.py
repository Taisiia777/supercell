...
#                     "Приятного пользования и всего доброго!"
#                 )
...
#                 # )
#                 text = (
#                     f"🎯По Вашему заказу №{self.order.number} был оформлен полный, или же частичный возврат!\n"
...
#         # )
#         text = (
#             f"🎯По вашему заказу №{self.order.number} к почте {self.email} указан неправильный код!\n"
#             f"❗️Пожалуйста, проверьте ваш почтовый ящик, затем укажите последний полученный код "
...
#         # )
#         text = (
#             f"🎯Оплата по заказу №{self.order.number} на сумму {self.order.total_incl_tax} руб. "
#             f"прошла успешно! ✅\nПожалуйста, ожидайте сообщения о выполнении вашего заказа!"
#         )
#         return text, None
import logging
from typing import Any
